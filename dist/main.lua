...
__lua("package-lock", "ModuleScript", "roblox-ts-game.rbxts_include.node_modules.@rbxts.hax.package-lock", "roblox-ts-game.rbxts_include.node_modules.@rbxts.hax", function()
	local _=__env("roblox-ts-game.rbxts_include.node_modules.@rbxts.hax.package-lock")local script,require=_.script,_.require return {
	dependencies = {
		["@eslint/eslintrc"] = {
			dev = true,
